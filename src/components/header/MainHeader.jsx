...
const MainHeader = () => {
  ...
  const handleOpenMenu = () => {
    setNavClass(
      "absolute top-0 left-0 h-full gap-y-[21px] font-bold flex flex-col bg-white md:flex md:flex-row p-8 md:mr-auto md:gap-4 md:static w-4/5 md:p-0 md:h-auto z-10"
    );
  };
